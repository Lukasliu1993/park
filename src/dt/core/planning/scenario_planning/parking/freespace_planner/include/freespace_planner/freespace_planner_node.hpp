...
private:
  ...
  rclcpp::Subscription<PoseStamped>::SharedPtr route_sub_;
  ...
  // functions, callback
  // void onRoute(const PoseStamped::ConstSharedPtr msg);
  ...
  bool isStopped(const std::deque<TwistStamped::ConstSharedPtr> & twist_buffer,
